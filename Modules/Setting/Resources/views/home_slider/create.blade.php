                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{route('home_slider.store')}}" method="post" id="create" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    @endforeach
                                        ...
                                        <div class="form-group{{ $errors->has('url') ? ' is-invalid' : "" }}">
                                            ...
                                            <input type="text" name="url" class="form-control" id="url"
                                                   value="{{Request::old('url')}}" placeholder="{{$custom[strtolower('Enter_url')]??"lang not found"}}">
                                        </div>
...
@section('script_style')
    {!! JsValidator::formRequest('Modules\Setting\Http\Requests\HomeSlider\CreateRequest','#create') !!}
@endsection
